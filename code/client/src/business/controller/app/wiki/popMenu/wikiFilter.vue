<template>
	<div style="width: 100%;height: 100%">
		<a-row>
			<a-input-search size="small" style="width: 200px" :placeholder="$t('placeholder.typeWikiSpaceName')" @search="onSearch" v-model="keyword"></a-input-search>
		</a-row>
...
const search=async (page:number)=>{
	let res=await (checkPermission(store.organizationPermission,Permission_Types.Organization.ADMIN)?apiWiki.list({
		page:page-1,
		size:10,
